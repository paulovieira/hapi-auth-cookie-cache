...
debugger;
    ...
    // note that the strategy mode can be configured per route (config.auth.mode)
    server.auth.strategy(options.strategy.name, 'cookie', false, cookieOptions);
                ...
                options.validateLoginData(request, function (err, session){
                    ...
                    sessionCache.set(
                        ...
                        function(err) {
                            ...
                            // it will be simply an object with the uuid of the session stored in the cache
                            var cookieData = {
                                uuid: uuid
                            };
